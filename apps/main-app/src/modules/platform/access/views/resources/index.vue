...
// 模块服务（左侧树，用作资源分类）
const moduleService = service.base.department;

// 资源服务（右侧表�?const resourceService = service.base.department },
    { id: 2, resourceNameCn: '用户详情', resourceCode: 'user_detail', resourceType: 'API', moduleId: 11, description: '获取用户详情接口', createTime: new Date().toISOString() },
    { id: 3, resourceNameCn: '部门列表', resourceCode: 'dept_list', resourceType: '页面', moduleId: 12, description: '部门列表页面', createTime: new Date().toISOString() },
    { id: 4, resourceNameCn: '角色列表', resourceCode: 'role_list', resourceType: '页面', moduleId: 21, description: '角色列表页面', createTime: new Date().toISOString() },
  ]
});
...
// 资源表格�?const resourceColumns = computed<TableColumn[]>(() => [
