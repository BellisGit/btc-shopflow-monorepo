...
// Mock数据服务
const policyService = service.base.department,
      description: '允许管理员完全管理用�?,
...
const columns = computed<TableColumn[]>(() => [
  ...
  { prop: 'priority', label: '优先�?, width: 100 },
...
const formItems = computed<FormItem[]>(() => [
  ...
  { prop: 'priority', label: '优先�?, span: 12, component: { name: 'el-input-number', props: { min: 0, max: 1000 } }, value: 100 },
