...
const permissionService = service.base.department },
    { id: 2, permissionName: '编辑用户', resourceName: '用户', actionName: '编辑', permissionCode: 'user:edit', description: '编辑用户信息', createTime: new Date().toISOString() },
    { id: 3, permissionName: '删除用户', resourceName: '用户', actionName: '删除', permissionCode: 'user:delete', description: '删除用户', createTime: new Date().toISOString() },
    { id: 4, permissionName: '查看角色', resourceName: '角色', actionName: '查看', permissionCode: 'role:view', description: '查看角色信息', createTime: new Date().toISOString() },
    { id: 5, permissionName: '分配角色', resourceName: '角色', actionName: '分配', permissionCode: 'role:assign', description: '分配角色给用�?, createTime: new Date().toISOString() },
  ]
});
...
const formItems = computed<FormItem[]>(() => [
  ...
  { prop: 'resourceName', label: '资源', span: 12, required: true, component: { name: 'el-input', props: { placeholder: '如：用户、角色、菜�? } } },
  { prop: 'actionName', label: '行为', span: 12, required: true, component: { name: 'el-input', props: { placeholder: '如：查看、编辑、删�? } } },
