...
const withSrc = (relativePath) => resolve(fileURLToPath(new URL('.', import.meta.url)), relativePath);
const withPackages = (relativePath) => resolve(fileURLToPath(new URL('../../packages', import.meta.url)), relativePath);
const withRoot = (relativePath) => resolve(fileURLToPath(new URL('../..', import.meta.url)), relativePath);
