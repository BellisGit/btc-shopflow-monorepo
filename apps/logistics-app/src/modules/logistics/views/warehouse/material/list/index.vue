...
const materialService: CrudService<any> = createWarehouseCrudService('SysMaterialMasterEntity');
...
const columns = computed<TableColumn[]>(() => [
  ...
  { label: t('logistics.material.fields.createdAt'), prop: 'createdAt', width: 180 },
  { label: t('logistics.material.fields.updatedAt'), prop: 'updatedAt', width: 180 },
]);
