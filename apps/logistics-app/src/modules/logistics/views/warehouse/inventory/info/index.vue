...
const inventoryInfoService: CrudService<any> = createWarehouseCrudService('SysCheckBaseEntity');
...
const columns = computed<TableColumn[]>(() => [
  ...
  { label: t('logistics.inventory.base.fields.startTime'), prop: 'startTime', width: 180 },
  { label: t('logistics.inventory.base.fields.endTime'), prop: 'endTime', width: 180 },
  ...
  { label: t('logistics.inventory.base.fields.createdAt'), prop: 'createdAt', width: 180 },
  { label: t('logistics.inventory.base.fields.updateAt'), prop: 'updateAt', width: 180 },
]);
