...
const inventoryDetailService: CrudService<any> = createWarehouseCrudService('SysCheckDiffEntity');

const columns = computed<TableColumn[]>(() => [
  { type: 'selection', width: 48 },
  { label: t('logistics.inventory.diff.fields.inventoryCheckId'), prop: 'inventoryCheckId', minWidth: 160 },
  ...
  { label: t('logistics.inventory.diff.fields.processTime'), prop: 'processTime', width: 180 },
