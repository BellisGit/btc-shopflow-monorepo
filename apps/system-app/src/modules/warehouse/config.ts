...
export default {
  ...
  columns: {
    'warehouse.material.list': [
      ...
      { prop: 'materialCode', label: 'warehouse.material.fields.material_code', minWidth: 160, showOverflowTooltip: true },
      { prop: 'materialName', label: 'warehouse.material.fields.material_name', minWidth: 180, showOverflowTooltip: true },
      { prop: 'materialType', label: 'warehouse.material.fields.material_type', minWidth: 140, showOverflowTooltip: true },
      { prop: 'specification', label: 'warehouse.material.fields.specification', minWidth: 140, showOverflowTooltip: true },
      { prop: 'materialTexture', label: 'warehouse.material.fields.material_texture', minWidth: 140, showOverflowTooltip: true },
      { prop: 'unit', label: 'warehouse.material.fields.unit', width: 100 },
      { prop: 'supplierName', label: 'warehouse.material.fields.supplier_name', minWidth: 180, showOverflowTooltip: true },
      { prop: 'unitPrice', label: 'warehouse.material.fields.unit_price', minWidth: 140 },
      { prop: 'taxRate', label: 'warehouse.material.fields.tax_rate', minWidth: 120 },
      { prop: 'totalPrice', label: 'warehouse.material.fields.total_price', minWidth: 140 },
    ...
    'warehouse.inventory.info': [
      { type: 'selection', width: 48 },
      { prop: 'checkNo', label: 'warehouse.inventory.info.fields.check_no', minWidth: 160, showOverflowTooltip: true },
      { prop: 'domainId', label: 'warehouse.inventory.info.fields.domain_id', minWidth: 140, showOverflowTooltip: true },
      { prop: 'checkType', label: 'warehouse.inventory.info.fields.check_type', minWidth: 140, showOverflowTooltip: true },
      { prop: 'checkStatus', label: 'warehouse.inventory.info.fields.check_status', minWidth: 140, showOverflowTooltip: true },
      ...
      { prop: 'checkerId', label: 'warehouse.inventory.info.fields.checker_id', minWidth: 140, showOverflowTooltip: true },
      { prop: 'remark', label: 'warehouse.inventory.info.fields.remark', minWidth: 200, showOverflowTooltip: true },
    ...
    'warehouse.inventory.detail': [
      ...
      { prop: 'materialCode', label: 'warehouse.inventory.detail.fields.material_code', minWidth: 160, showOverflowTooltip: true },
      { prop: 'diffReason', label: 'warehouse.inventory.detail.fields.diff_reason', minWidth: 200, showOverflowTooltip: true },
      { prop: 'processPerson', label: 'warehouse.inventory.detail.fields.process_person', minWidth: 140 },
      { prop: 'processTime', label: 'warehouse.inventory.detail.fields.process_time', width: 180 },
      { prop: 'processRemark', label: 'warehouse.inventory.detail.fields.process_remark', minWidth: 200, showOverflowTooltip: true },
    ] as TableColumn[],
  },
