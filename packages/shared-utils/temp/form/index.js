...
exports.formHook = exports.format = void 0;
exports.registerFormHook = registerFormHook;
// 辅助函数
...
function registerFormHook(name, fn) {
    exports.format[name] = fn;
}
exports.default = formHookDefault;
exports.formHook = formHookDefault;
