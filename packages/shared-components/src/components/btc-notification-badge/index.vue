<template>
  <div class="btc-notification-badge">
    <el-badge
      :value="displayCount"
      :max="99"
      :class="['btc-notification-badge__badge', { 'is-hidden': shouldHide, 'is-animating': isAnimating }]"
    >
      <div class="btc-notification-badge__placeholder"></div>
    </el-badge>
  </div>
</template>
