...
|---------|--------|-----------|-------------|----------|
| ❌ production-app | 13 | 2 | TS6307:12, TS2305:1 | [production_app_errors.txt](./production_app_errors.txt) |
| ❌ finance-app | 12 | 1 | TS6307:12 | [finance_app_errors.txt](./finance_app_errors.txt) |
| ❌ engineering-app | 12 | 1 | TS6307:12 | [engineering_app_errors.txt](./engineering_app_errors.txt) |
...
|---------|--------|-----------|-------------|----------|
| ❌ packages (合并) | 9 | 2 | TS2683:7, TS2345:1, TS7016:1 | [packages_errors.txt](./packages_errors.txt) |

## 错误代码汇总

| 错误代码 | 总数 | 官方含义 |
|---------|------|----------|
| TS6307 | 36 | 文件未在 tsconfig.json 的项目文件列表中 |
| TS2683 | 7 | [查看官方文档](https://www.typescriptlang.org/docs/handbook/error-codes.html) |
| TS2305 | 1 | 模块/命名空间中不存在指定的导出成员 |
| TS2345 | 1 | [查看官方文档](https://www.typescriptlang.org/docs/handbook/error-codes.html) |
| TS7016 | 1 | [查看官方文档](https://www.typescriptlang.org/docs/handbook/error-codes.html) |
